...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    py::class_<QuantizedGEMM>(m, "QuantizedGEMM")
        ...
        .def("loadParam", &QuantizedGEMM::loadParam)
    ...
    ;
    py::class_<QuantizedGEMMW4A4>(m, "QuantizedGEMMW4A4")
        // .def(torch::init<>())
        .def(py::init<>())
        .def("gemm", &QuantizedGEMMW4A4::gemm)
        .def("quantize_pack_w4a4_wgt", &QuantizedGEMMW4A4::quantize_pack_w4a4_wgt)
    ;
}
